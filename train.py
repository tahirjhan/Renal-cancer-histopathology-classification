...
from models.Hybrid_Histoformer import RCGNet

def get_model():
    input_shape = (256, 256, 3)
    weight_decay = 1e-3  # Set the weight decay value
...
if __name__ == '__main__':
    ...
    early_stop = tf.keras.callbacks.EarlyStopping(
        monitor='val_loss', patience=5, verbose=2, mode='min', restore_best_weights=True)
